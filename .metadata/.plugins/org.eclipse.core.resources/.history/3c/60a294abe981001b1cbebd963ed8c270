					...
					<div class="w3-padding-16" style="display: flex">
						<select class="w3-select w3-padding-16" name="appointmentDate">
							...
							<c:forEach var="appointment" items="${appointments}">
								<option class="w3-padding-16" value="${appointment.appointmentDate}, ${appointment.id}">${appointment.appointmentDate}</option>
							</c:forEach>
						...
						<select class="w3-select w3-padding-16" name="appointmentTime">
							...
							<c:forEach var="appointment" items="${appointments}">
								<option class="w3-padding-16" value="${appointment.appointmentTime}">${appointment.appointmentTime}</option>
							</c:forEach>
						...
						<select class="w3-select w3-padding-16" name="seatsNumber">
							...
							<c:forEach var="appointment" items="${appointments}">
								<option class="w3-padding-16" value="${appointment.seatsNumber}">${appointment.seatsNumber}</option>
							</c:forEach>
						</select>
					</div>
					<button
